...
extern SEXP mpeg_decode_audio_(SEXP ctx_, SEXP n_);
extern SEXP mpeg_seek_        (SEXP ctx_, SEXP time_, SEXP exact_);
extern SEXP mpeg_rewind_      (SEXP ctx_);
...
static const R_CallMethodDef CEntries[] = {
  ...
  {"mpeg_decode_audio_", (DL_FUNC) &mpeg_decode_audio_, 2},
  {"mpeg_seek_"        , (DL_FUNC) &mpeg_seek_        , 3},
  {"mpeg_rewind_"      , (DL_FUNC) &mpeg_rewind_      , 1},
