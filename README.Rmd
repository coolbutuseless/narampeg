...
`narampeg` is a video decoder which supports mpeg1 video and mp2 audio.  Realtime decoding+playback works (tested on a Mac M2).
...
* Figure out way to playback gapless audio. I don't think this is possible with 
